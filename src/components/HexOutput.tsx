...
export const HexOutput: React.FC<HexOutputProps> = ({ hexDump, hasData }) => {
  if (!hasData) {
    return (
      <div className="bg-gray-900 text-gray-300 p-4 rounded-lg font-mono text-base leading-relaxed h-80 overflow-y-auto whitespace-pre-wrap shadow-sm border border-gray-700 mb-6">
