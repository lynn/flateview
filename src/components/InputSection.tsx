  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-700 mb-6">
      ...
      <textarea
        ...
        className="w-full min-h-[120px] p-4 border-2 border-gray-600 rounded-lg font-mono text-lg resize-y transition-colors focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 bg-gray-900 text-gray-100 placeholder-gray-400"
      />
